...
class Layer(ResourceBase):
    ...
    typename = models.CharField(max_length=128, null=True, blank=True, editable=False)

    is_mosaic = models.BooleanField(verbose_name='Mosaico', default=False)
    has_time = models.BooleanField(verbose_name='Tiempo', default=False)
    has_elevation = models.BooleanField(verbose_name='Elevación', default=False)
    time_regex = models.CharField(
        ...
        editable=False,
        choices=TIME_REGEX)
    elevation_regex = models.CharField(max_length=128,
                                       null=True,
                                       blank=True,
                                       editable=False)
