...
class Profile(AbstractUser):
    ...
    voice = models.CharField(_('Voice'), max_length=255, blank=True, null=True, editable=False, help_text=_(
        'telephone number by which individuals can speak to the responsible organization or individual'))
    fax = models.CharField(_('Facsimile'), max_length=255, blank=True, null=True, editable=False, help_text=_(
    ...
    delivery = models.CharField(
        ...
        blank=True,
        null=True,
        help_text='Dirección física en la que se puede contactactar')
