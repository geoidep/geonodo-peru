...
class ResourceBase(PolymorphicModel, PermissionLevelMixin, ItemBase):
    ...
    data_quality_statement_help_text = _(
        ...
        ' dataset')
    nombre_contacto_help_text = ('Nombre del responsable de la información.')
    organizacion_contacto_help_text = ('Nombre de la organizacion del responsable.')
    correo_contacto_help_text = ('Correo electrónico del responsable de la información.')
    denominador_help_text = ('Número denominador de la resolución.')
    limitacion_uso_help_text = ('Limitación del Uso.')
    restriction_code_access_help_text = ('Limitaciones colocadas al momento del acceso de los datos.')
    nombre_archivo_help_text = ('Nombre del archivo')
    version_archivo_help_text = ('Versión del archivo')
    # internal fields
    ...
    nombre_contacto = models.CharField(
        verbose_name=_("Nombre del Contacto"),
        max_length=255,
        null=True,
        blank=True,
        help_text=nombre_contacto_help_text)
    organizacion_contacto = models.CharField(
        verbose_name="Nombre de la Organización del Contacto",
        max_length=255,
        null=True,
        blank=True)
    correo_contacto = models.CharField(
        ...
        null=True,
        blank=True)
    denominador = models.CharField(
        verbose_name="Resolución Espacial",
        max_length=12,
        null=True,
        blank=True,
        help_text=denominador_help_text)
    ...
    nombre_archivo = models.CharField(
        ...
        null=True,
        blank=True,
        help_text=nombre_archivo_help_text)
    version_archivo = models.CharField(
        verbose_name='Versión del archivo',
        max_length=255,
        null=True,
        blank=True,
        help_text=version_archivo_help_text)
    # Section 8
    ...
    limitacion_uso = models.CharField(verbose_name='Limitación de Uso',
                                      max_length=255,
                                      null=True,
                                      blank=True,
                                      help_text=limitacion_uso_help_text)
    ...
    metadata_uploaded_preserve = models.BooleanField(verbose_name='Preservar metadatos cargados', default=False)
    ...
    featured = models.BooleanField(verbose_name='Destacado', default=False, help_text=
        'Debería ser publicado éste recurso en la página de inicio?')
    is_published = models.BooleanField(
        verbose_name='Publicado',
        default=True,
        help_text='Se debe publicar e indexar éste recurso?')
    is_approved = models.BooleanField(
        verbose_name='Aprobado',
        default=True,
        help_text='Este recurso está validado por un publicador o editor?')
